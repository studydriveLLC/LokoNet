...
export default function MenuScreen({ navigation }) {
  ...
  const executeLogout = () => {
    console.log("Déconnexion confirmée. Nettoyage du token...");
    // C'est ici que tu appelleras ton action Redux : dispatch(logout())
  };
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      {/* La nouvelle modale de déconnexion premium */}
      <LogoutModal 
